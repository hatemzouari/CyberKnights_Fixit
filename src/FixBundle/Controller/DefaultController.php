...

{
    ...
    public function showpostclientAction(){
        ...
        return $this->render('@Fix/Client/showpostclient.html.twig',array('postes'=>$postes,'user'=>$currentuser,'souscategorie'=>$souscategorie));
    }
    ...
    public function findpostsouscategorieAction(Request $request) {
        $currentuser=$this->getUser();
        $listecategorie = $request->get('listcategorie');
        $poste= $this->getDoctrine()->getRepository(Post::class)->findBySouscategorie($listecategorie);
        return $this->render('@Fix/Client/AfficheDQLsouscategorie.html.twig',array('postes'=>$poste,
            'user'=>$currentuser));
    }
}
